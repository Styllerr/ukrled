...
metricSelect.forEach(element => {
    element.addEventListener('change', (event) => changeMetric(event.target.id))
});
    ...
    switch (metric) {
        ...
        case "metric-sm":
            if (newMetric === "metric-mm") {
                ...
                widthRange.setAttribute('step', resolution.h / 10);
                heightRange.setAttribute('step', resolution.v / 10);
            }
            break;
        case "metric-m":
            if (newMetric === "metric-mm") {
                ...
                widthRange.setAttribute('step', resolution.h / 1000);
                heightRange.setAttribute('step', resolution.v / 1000);
            }
            break;
        default:
            break;
